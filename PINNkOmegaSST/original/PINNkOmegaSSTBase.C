...
void PINNkOmegaSSTBase<BasicEddyViscosityModel>::correct()
{
    ...
    #include "/mnt/hhk/OpenFOAM/PINNv/PINNkOmegaSST/createFeatures.H"
    #include "/mnt/hhk/OpenFOAM/PINNv/PINNkOmegaSST/getInputFeatures.H"
    #include "/mnt/hhk/OpenFOAM/PINNv/PINNkOmegaSST/outputFeatures.H"
